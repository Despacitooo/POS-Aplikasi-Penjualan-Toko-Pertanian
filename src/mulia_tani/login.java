...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome To Mulia Tani");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mulia_tani/3.jpg"))); // NOI18N
...
String username = "nofi";
String password = "12345678";
if(username.equalsIgnoreCase(txtuser.getText()) && password.equalsIgnoreCase(txtpassword.getText())) {
        this.setVisible(false);
        new menu_utama().setVisible(true);
    }else{
            javax.swing.JOptionPane.showMessageDialog(null, "MAAF MASUKKAN USER DAN PASSWORD ANDA SALAH !");
            txtuser.setText("");
            txtpassword.setText("");
